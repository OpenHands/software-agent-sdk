...
class InstalledCanvasExtensionResponse(BaseModel):
    ...
    @classmethod
    def from_info(
        cls, info: InstalledCanvasExtensionInfo
...
def install_canvas_extension_endpoint(
    ...
    try:
        ...
        return InstalledCanvasExtensionResponse.from_info(info)
...
def list_installed_canvas_extensions_endpoint() -> (
    ...
    return InstalledCanvasExtensionsListResponse(
        canvas_extensions=[InstalledCanvasExtensionResponse.from_info(i) for i in infos]
    )
