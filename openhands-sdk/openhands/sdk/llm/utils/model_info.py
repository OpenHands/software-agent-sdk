...
from openhands.sdk.llm.utils.model_cost_map import log_model_cost_map_provenance
...
def get_litellm_model_info(
    ...
    # Single funnel for model metadata, so this is where the provenance of the
    # database behind it gets recorded.
    log_model_cost_map_provenance()
    return _get_litellm_model_info(secret_api_key, base_url, model)
