...
def test_extract_linked_issue_numbers_preserves_repo_and_deduplicates():
    body = (
        "Fixes #12 and closes Other/Project#12\n"
        "## Issue Number\norg/repo#12, other/project#12, Other/Project#34\n"
    )
    assert extract_linked_issue_numbers(body, "org/repo") == [
        ("org/repo", 12),
        ("other/project", 12),
        ("other/project", 34),
    ]
...
def test_extract_linked_issue_numbers_bare_ref_uses_this_repo():
    body = "## Issue Number\n#123\n"
    assert extract_linked_issue_numbers(body, "org/repo") == [("org/repo", 123)]
