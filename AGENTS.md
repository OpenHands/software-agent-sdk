...
# Start agent-server in Docker (software-agent-sdk v1.43.1)
...
- The integration workflow pins `ghcr.io/openhands/agent-server:1.43.1-python`, which corresponds to the `software-agent-sdk` release `v1.43.1`.
