...
- Dependabot's `uv` ecosystem has discovered and updated workspace-member dependencies since `dependabot-core#14627` was deployed in May 2026, but Python updates remain disabled in `.github/dependabot.yml`. As of the August 2026 recheck, workspace update correctness gaps remain in `dependabot-core#14004`, `dependabot-core#15558`, and `dependabot-core#15786`; uv grouping and dependency-name casing gaps remain in `dependabot-core#13202`, `dependabot-core#14665`, and `dependabot-core#14119`. See issue #2510.
